...
@Component
public class BookAPIWebExceptionHandler extends AbstractErrorWebExceptionHandler {

    public BookAPIWebExceptionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources,
